...
var MessageLang={
  ...
  StandardDeviation: {"cat": "Desviació estàndard", "spa": "Desviació estándar", "eng": "Standard deviation", "fre": "Écart-type"},
	...
	miramon: {
		...
		CloseBrowser: {"cat":"Pots tancar el navegador", "spa":"Puedes cerrar el navegador", "eng":"You can close the browser", "fre":"Vous pouvez fermer le navigateur"},
		...
		PropertyMustBeIsInstead: {"cat": "La propietat atributs.mostrar ha de ser \"si\", \"si_ple\", \"no\" i en canvi està definit com a \"true/false\"", "spa": "La propiedad atributs.mostrar debe ser \"si\", \"si_ple\", \"no\" y en cambio está definido como \"true/false\"", "eng": "The property atributs.mostrar must be \"si\", \"si_ple\", \"no\" and is instead set to \"true/false\"", "fre": "La propriété atributs.mostrar doit être \"si\", \"si_ple\", \"no\" et est à la place définie sur \"true/false\""},
		MayContinue: {"cat": "Es deixa continuar", "spa": "Se deja continuar", "eng": "You may continue", "fre": "Il est permis de continuer"},
		PropertyMustBeIsOtherwiseDefined: {"cat": "La propietat atributs.mostrar ha de ser \"si\", \"si_ple\", \"no\" i en canvi està definida d'una altra manera", "spa": "La propiedad atributs.mostrar debe ser \"si\", \"si_ple\", \"no\" y en cambio está definido de otra manera", "eng": "The property atributs.mostrar must be \"si\", \"si_ple\", \"no\" and is otherwise defined", "fre": "La propriété atributs.mostrar doit être \"si\", \"si_ple\", \"no\" et est définie autrement"},
