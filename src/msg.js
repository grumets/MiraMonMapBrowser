...
var MessageLang={
	...
	TheLayer: {"cat":"La capa", "spa":"La capa", "eng":"The layer", "fre":"La couche"},
	ofTheLayer: {"cat": "de la capa", "spa": "de la capa", "eng": "of the layer", "fre": "de la couche"},
  ...
  StandardDeviation: {"cat": "Desviació estàndard", "spa": "Desviació estándar", "eng": "Standard deviation", "fre": "Écart-type"},
	...
	cntxmenu: {
		...
		originNorthClockwiseDegress: {"cat":"origen al nord i en sentit horari (en graus)", "spa":"origen en el norte y en el sentido de las agujas del reloj (en grados)", "eng":"origin north and clockwise (in degress)", "fre":"origine au nord et dans le sens des aiguilles d'une montre (en degrés)"},
	...
	consult:{
		...
		ProfileTransversalCutQueriedLine: {"cat": "Perfil del tall transversal de la línia consultada", "spa": "Perfil del corte transversal de la línea consultada", "eng": "Profile of the transversal cut of the queried line", "fre": "Profil de la coupe transversale de la ligne interrogée"},
	...
	histopie:{
		...
		Similarity: {"cat": "Semblança", "spa": "Similitud", "eng": "Similarity", "fre": "Similitude"},
	...
	miramon: {
		...
		notMatchVersion: {"cat": "no es correspon amb la versió de", "spa": "no se corresponde con la versión de", "eng": "it does not match with the version of", "fre": "ne correspond pas à la version de"},
		...
		SavingStatusMapNotPossible: {"cat":"No serà possible guardar l'estat del mapa",	"spa":"No será posible guardar el estado del mapa",	"eng":"Saving the status of the map will not be possible",	"fre":"Il ne sera pas possible de sauvegarder le statut de la carte"},
	...
	authens: {
		...
		ContinueWithoutAuthentication: {"cat": "Vols continuar sense autentificació", "spa": "Desea continuar sin autentificación", "eng": "Do you want to continue without authentication", "fre": "Faites-vous quoi continuer sans authentification"},
	...
	llinatge: {
		...
		TheSubtractionFirst: {"cat":"La resta de la primera", "spa":"La resta del primero", "eng":"The subtraction of the first", "fre":"La soustraction de la première"},
	...
	owsc: {
		...
		DisabledLayersCannotOpened: {"cat":"Les capes inactives no es poden obrir (moure el punter per sobre del nom mostrarà una descripció del motiu)", "spa":"Las capas inactivas no se pueden abrir (mover el puntero por encima del nombre mostrará una descripción del motivo)", "eng":"Disabled layers cannot be opened (move the cursor over the layer name will show a description of the reason)", "fre":"Les couches inactives ne peuvent pas être ouvertes (mouvoir le pointeur sur le nom montrera une description du motif)"},
	...
	qualitat: {
		...
		NoObservationsValidObtainValidity: {"cat": "No hi ha observacions amb valors vàlids per obtenir la vàlidessa temporal en aquesta àrea", "spa": "No hay observaciones con valores válidos para obtener la validez temporal en esta área", "eng": "There are no observations with valid values to obtain temporal validity in this area", "fre": "Il n'y a pas d'observations avec des valeurs valides pour obtenir la validité temporelle dans ce domaine"},
		...
		NoObservationsValidityPositions: {"cat": "No hi ha observacions amb valors vàlids per obtenir la validessa de les posicions de les observacions en aquesta àrea", "spa": "No hay observaciones con valores válidos para obtener la validez de las posiciones de las observaciones en esta área", "eng": "There are no observations with valid values to obtain the validity of the positions of observations in this area", "fre": "Il n'y a pas d'observations avec des valeurs valides pour obtenir la validité des positions des observations dans ce domaine"},
		...
		NoObservationsPositionalUncertainty: {"cat": "No hi ha observacions amb incertesa posicional en aquesta àrea", "spa": "No hay observaciones con incertidumbre posicional en esta área", "eng": "There are no observations with positional uncertainty in this area", "fre": "Il n'y a pas d'observations avec une incertitude de position dans ce domaine"},
		...
		QualityAssessment: {"cat":"Mètode d'avaluació de la qualitat", "spa":"Método de evaluación de la calidad", "eng": "Quality assessment", "fre":"Méthode d'évaluation de la qualité"},
	...
	tools: {
		...
		notDefinedNotFunctionality: {"cat":"i per tant no es pot usar la funcionalitat", "spa":"y en consecuencia no se puede usar la funcionalidad", "eng":"has not been defined and its not possible to use the functionality", "fre":"n'a été pas définie et il n'est donc pas possible d'utilise l'outil"},
	...
	wps: {
		...
		notAnyExecProcessDefined: {"cat":"no té capa procés executable definit", "spa":"no tiene ningún proceso ejecutable definido", "eng":"do not have any executable process defined", "fre":"n'a aucun processus exécutable définit"},
	...
	urls: {
		...
		installerMMRExe: {"cat":"https://www.miramon.cat/mmr/cat/exe/Inst_MMR.EXE", "spa":"https://www.miramon.cat/mmr/esp/exe/Inst_MMR.EXE", "eng":"https://www.miramon.cat/mmr/usa/exe/Inst_MMR.EXE", "fre":"https://www.miramon.cat/mmr/usa/exe/Inst_MMR.EXE"}
	}
}
