...
{
	alert(GetMessage("FinishValidation", "miramon") + ". " + GetMessage("CloseBrowser", "miramon") + ".");
	return;
}
				...
				if (capa.atributs[j].mostrar)
				{
					if (capa.atributs[j].mostrar != "si" && capa.atributs[j].mostrar != "si_ple" && capa.atributs[j].mostrar != "no")
					{
						if (capa.atributs[j].mostrar == true || capa.atributs[j].mostrar == false)
						{
							...
							{
								alert(GetMessage("PropertyMustBeIsOtherwiseDefined", "miramon") + ". " + GetMessage("ValueIgnoredAttributeShowable", "miramon") + ". " + GetMessage("MayContinue", "miramon") + ". " + " capa = " + DonaCadenaNomDesc(capa));
						...
						else
						{
							if (!avis_mostrar_atributs)
							{
								alert(GetMessage("PropertyMustBeIsInstead", "miramon") + ". " + GetMessage("MayContinue", "miramon") + ". " + " capa = " + DonaCadenaNomDesc(capa));
								avis_mostrar_atributs=true;
							}
							capa.atributs[j].mostrar = "si";
						}
