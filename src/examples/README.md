...
To load the browser using them use URL such as:
  * For the BCN Reconnecta browser: http://localhost/MiraMonMapBrowser/src/?config=examples/bcnreconnecta.json.json
  * For the Catalan Data Cube browser: http://localhost/MiraMonMapBrowser/src/?config=examples/cdc.json
  * For Digital Height Model browser: http://localhost/MiraMonMapBrowser/src/?config=examples/dhm.json
